...
class VmPickerGroup extends StatefulWidget {
  const VmPickerGroup({super.key, required this.items, this.selected, this.onSelected, this.controller});

  const VmPickerGroup.controlled(this.controller, {super.key, this.selected, required this.items, this.onSelected});
...
class _VmPickerListTile extends StatelessWidget {
  const _VmPickerListTile({required this.title, required this.selected, required this.onTap});
...
final class PickerItem {
  ...
  const PickerItem({required this.id, required this.title});
}
