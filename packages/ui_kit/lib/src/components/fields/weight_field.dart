...
class WeightField extends StatelessWidget {
  const WeightField({super.key, this.initial, this.controller, this.focusNode, this.errorText});
  ...
  Widget build(BuildContext context) {
    return VmTextField(
      ...
      showCounter: false,
      decoration: InputDecoration(suffixText: 'кг', hintText: '80', errorText: errorText),
    );
  }
}
