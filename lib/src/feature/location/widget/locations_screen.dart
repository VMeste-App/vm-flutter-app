...
import 'package:vm_app/src/feature/location/controller/search/search_location_controller.dart';
...
class _LocationsScreenState extends State<LocationsScreen> {
  ...
  Widget build(BuildContext context) {
    return ControllerScope<SearchLocationController>(
      () => SearchLocationController(repository: LocationRepository())..fetch(const LocationFilter()),
      child: StateConsumer<SearchLocationController, SearchLocationState>(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      trailing: GestureDetector(
                        onTap: () => VmNavigator.push(context, VmLocationPage(id: 1)),
