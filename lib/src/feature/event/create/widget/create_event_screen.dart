...
import 'package:vm_app/src/feature/event/create/controller/vm_event_create_controller.dart';
...
class _CreateEventScreenState extends State<CreateEventScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ControllerScope<VmEventCreateController>(
      () => VmEventCreateController(repository: Dependencies.of(context).eventRepository),
      child: SafeScaffold(
            ...
            children: [
              ...
              VmLabel(
                ...
                child: VmTextField(
                  ...
                  onTap: () => VmNavigator.push(context, const VmLocationsPage()),
                ),
              ),
